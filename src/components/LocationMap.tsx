...
const LocationMap: React.FC = () => {
  ...
  const API_KEY = "AIzaSyAXDphdVNg-TNL7cYoEpyJ-xXY7kRkueYc";
      ...
      <div className="map-container">
        ...
        <div className="map-wrapper">
          {API_KEY === "YOUR_GOOGLE_MAPS_API_KEY_HERE" ? (
            // Fallback static map when API key is not configured
            <>
              <iframe
              ...
              <div className="api-key-notice">
                <p>⚠️ Please configure your Google Maps API key to enable interactive map with office markers</p>
              </div>
            </>
          ) : (
            // Interactive map with markers when API key is configured  
